...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2898&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-grappelli-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-grappelli` can be installed with `conda`:
...
```
mamba install django-grappelli
```

It is possible to list all of the versions of `django-grappelli` available on your platform with `conda`:
...
```
mamba search django-grappelli --channel conda-forge
```
...
mamba repoquery search django-grappelli --channel conda-forge

# List packages depending on `django-grappelli`:
mamba repoquery whoneeds django-grappelli --channel conda-forge

# List dependencies of `django-grappelli`:
mamba repoquery depends django-grappelli --channel conda-forge
```
